...
identifier: openclaw/baoyu-danger-x-to-markdown
...
- Preserved directories:
  ...
  - references: yes
  - prompts: no
- External dependencies: bun, chrome, social-platform-access
- Risk level: high
- Environment variables (detected): `API`, `HOME`, `X_AUTH_TOKEN`
...
Detected env vars: `API`, `HOME`, `X_AUTH_TOKEN`
